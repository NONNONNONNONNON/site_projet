...
<html>
			<form method = "post" action = "Inscription.php">
				<p> <h3> Veuillez rentrer différentes informations afin de créer votre profil. </h3> </p>
				<div class = "main">
					<label> Genre : </label>
						<ul>
							<li> <input type = "radio" name = "genre" value = "Homme" required> Homme </li>
							<li> <input type = "radio" name = "genre" value = "Femme" required> Femme </li>
							<li> <input type = "radio" name = "genre" value = "I'M A FUCKING ROBOT!!" required> I AM A FUCKING ROBOT </li>
						</ul>
					<label> Pays : </label>
					<select name="pays"> 
				...
				<div>
					...
					<label> Mot de passe : </label>
						<input type = "password"  name = "inipassword" required> <br> <br>
					<label> Confirmez votre mot de passe : </label>
						<input type = "password" name = "inipassword2" required> <br> <br>
					<label> E-mail : </label>
		...
		catch(Exception $e)
		{
			...
			echo "BWA BWA MARCHE PAS";
		}


		if(!array_key_exists('inipassword', $_POST) && !array_key_exists('inipassword2', $_POST) && !array_key_exists('genre', $_POST) && !array_key_exists('email', $_POST) && !array_key_exists('pseudo', $_POST))
		{
		}
		else
		{
		if($_POST['inipassword'] != $_POST['inipassword2'] || $_POST['inipassword'] != NULL)
		{
			echo '<h1><bold> NON !<bold></h1>';
		}
		else
		{
			$e = $bdd->prepare("INSERT INTO users(PSEUDO, PAYS, GENRE, PASSWORD, E_MAIL)VALUES(:pseudo, :pays, :genre, :inipassword, :email)");
			$e->execute(array(
				"pseudo" => $_POST['pseudo'],
				"pays" => $_POST['pays'],
				"genre" => $_POST['genre'],
				...
				"email" => $_POST['email']));
			echo "vous etes enregistré ! enfin , peut etre, j'espere pour vous ";
		}
		}
		?>
		</div>
